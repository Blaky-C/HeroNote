...
public class MyRichTextEditor extends ScrollView {
    ...
    public MyRichTextEditor(Context context) {
        this(context, null);
    }

    public MyRichTextEditor(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyRichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
